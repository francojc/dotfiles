...
-- Code
map({ 'n', 'v' }, '<leader>cf', "<Cmd>lua require('conform').format({lsp_format = 'fallback'})<Cr>", { desc = 'Format code' })
...
map('n', '<leader>mp', "<Cmd>lua require('img-clip').paste_image({dir_path = 'images', relative_to_current_file = true })<Cr>", { desc = 'Paste image' })
