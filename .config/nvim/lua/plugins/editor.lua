...
require("mini.surround").setup({
	custom_surroundings = {
		...
		-- highlight {==text==}, use the <leader>mh mapping in
		-- after/ftplugin/markdown.lua or the text-object ih/ah.
		h = {
		...
		-- See also: after/ftplugin/markdown.lua for <leader>m* wrappers.
		i = {
			-- Insert: {++text++}
			output = function()
				return { left = "{++", right = "++}" }
