...
-- Obsidian -----------------------------------
map("n", "<leader>oN", "<Cmd>Obsidian new from template<Cr>", { desc = "New from template" })
map("n", "<leader>ob", "<Cmd>Obsidian backlinks<Cr>", { desc = "Backlinks" })
map("n", "<leader>od", "<Cmd>Obsidian dailies<Cr>", { desc = "Daily note" })
map("n", "<leader>of", "<Cmd>Obsidian follow link<Cr>", { desc = "Follow link" })
map("n", "<leader>oi", "<Cmd>Obsidian paste img<Cr>", { desc = "Paste image" })
map("n", "<leader>ol", "<Cmd>Obsidian link new<Cr>", { desc = "New link" })
map("n", "<leader>on", "<Cmd>Obsidian new<Cr>", { desc = "New note" })
map("n", "<leader>oq", "<Cmd>Obsidian quick switch<Cr>", { desc = "Quick switch" })
