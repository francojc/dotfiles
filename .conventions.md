...
- **Primary programming languages**: I primarily work with R, Python, and Bash (for local scritps). Occasionally I work with other languages as needed (HTML, CSS, JavaScript, etc.).
